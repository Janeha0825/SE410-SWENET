...
namespace SwenetDev 
{
	...
	/// </summary>
	public class editModule : System.Web.UI.Page 
	{
		...
		protected MaterialsControl MaterialsControl1;
		...
		protected System.Web.UI.WebControls.Button CancelBtnTop;
		...
		private void deleteTempMaterials() 
		{
			...
			if( Directory.Exists( path ) ) 
			{
				...
				{
					Response.Redirect( "MyAccount.aspx?message=EditModule: An error occured while trying to remove existing material: " + filenames[pos] );
				}
			}
