<%@ Control Language="c#" AutoEventWireup="false" Codebehind="RateMaterialControl.ascx.cs" Inherits="SwenetDev.Controls.RateMaterialControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
