...
<%@ Page Language="c#" Debug="true" CodeBehind="editModule.aspx.cs" AutoEventWireup="false" Inherits="SwenetDev.editModule" validateRequest="false" smartNavigation="True"%>
...
<%@ Register TagPrefix="swenet" TagName="materials" Src="Controls\MaterialsControl.ascx" %>
		...
		<form id="Form1" action="uploadResult.aspx" runat="server">
			...
			<table cellspacing="1" cellpadding="1" width="750" id="Table1">
				<tr>
					...
					<td width="600" style="FLOAT: right; WIDTH: 600px !important">
						...
						<p><asp:button id="BackBtnTop" runat="server" text="&larr; Back" cssclass="navButton" causesvalidation="False"
								commandname="Back" /><asp:button id="NextBtnTop" runat="server" text="Next &rarr;" cssclass="navButton" causesvalidation="False"
								commandname="Next" /><asp:button id="SaveBtnTop" runat="server" text="Save for Later" cssclass="navButton" causesvalidation="False" />
							<asp:button id="SubmitBtnTop" onclick="SubmitBtn_Click" runat="server" text="Submit" cssclass="navButton" />
							<asp:Button ID="CancelBtnTop" OnClick="CancelBtn_Click" Runat="server" Text="Cancel Revision"
								CssClass="navButton" /></p>
						<asp:label id="ErrorMessage" runat="server" forecolor="Red"></asp:label><asp:panel id="Panel0" runat="server">
							<P>
								<asp:validationsummary id="ValidationSummary1" runat="server" headertext="The following fields are required:"></asp:validationsummary><I>All 
									fields are required except where noted.</I>&nbsp;
								<BR>
								<BR>
								To add a new entry to a table, click&nbsp;<STRONG>New</STRONG>, and then <STRONG>Apply</STRONG>
								to commit or <STRONG>Cancel</STRONG> to cancel that entry.&nbsp; To edit an 
								entry, click on its hyperlinked text.</P>
							<asp:panel id="VariantPanel" runat="server">
								<P>To create a variant of a module, select the module from the list below and click <STRONG>
									...
									that module.</P>
								<P>To reorder the items in a specified area, click the buttons next to the item to change the location of that specific item.  
								   Click the <strong>Up Arrow</strong> to increase the item's location in the list and click the <strong>Down Arrow</strong> 
								   to decrease the item's location in the list.</P>
								<P>
							...
							<TABLE id="GeneralTable" cellSpacing="0" cellPadding="0" width="596">
								<TR>
									<TD style="HEIGHT: 51px"><STRONG>Title</STRONG><BR>
										<asp:textbox id="Title" runat="server" maxlength="300" columns="74" width="580px"></asp:textbox>
										<asp:requiredfieldvalidator id="TitleValidator" runat="server" controltovalidate="Title" errormessage="Title"
											display="Dynamic">*Required Field</asp:requiredfieldvalidator></TD>
								</TR>
								<TR>
								...
								<TR>
									<TD><STRONG>Size</STRONG> <A href="javascript:openPopup(1)"><STRONG><IMG src="images/help.jpg" border="0"></STRONG></A><BR>
										<BR>
										<EM>(Optional)<BR>
										</EM>
										<BR>
										<TABLE id="SizeTable" style="WIDTH: 488px; HEIGHT: 82px" cellSpacing="1" cellPadding="1"
											...
											<TR>
												...
												<TD style="WIDTH: 173px; HEIGHT: 18px">
													<asp:textbox id="Lecture" runat="server" maxlength="50" columns="20"></asp:textbox></TD>
												<TD style="HEIGHT: 18px"><STRONG>Homework:</STRONG></TD>
												<TD style="HEIGHT: 18px">
													<asp:textbox id="Homework" runat="server" maxlength="50" columns="20"></asp:textbox></TD>
											</TR>
											<TR>
												<TD style="WIDTH: 9px"></TD>
												<TD style="WIDTH: 63px"><STRONG>Lab:</STRONG></TD>
												<TD style="WIDTH: 173px">
													<asp:textbox id="Lab" runat="server" maxlength="50" columns="20"></asp:textbox></TD>
												<TD><STRONG>Other:</STRONG></TD>
												<TD>
													<asp:textbox id="Other" runat="server" maxlength="50" columns="20"></asp:textbox></TD>
											</TR>
											<TR>
												...
												<TD style="WIDTH: 173px; HEIGHT: 26px">
													<asp:textbox id="Exercise" runat="server" maxlength="50" columns="20"></asp:textbox></TD>
								...
								<TR>
									<TD><STRONG>Abstract <A href="javascript:openPopup(2)"><IMG src="images/help.jpg" border="0"></A><BR>
										...
										<asp:textbox id="Abstract" runat="server" maxlength="400" columns="74" width="580px" rows="5"
											textmode="MultiLine"></asp:textbox>
										<asp:requiredfieldvalidator id="AbstractValidator" runat="server" controltovalidate="Abstract" errormessage="Abstract"
											display="Dynamic">*Required Field</asp:requiredfieldvalidator></TD>
								</TR>
							</TABLE>
							...
							<P><STRONG>Author Comments</STRONG> <FONT size="2"><A href="javascript:openPopup(5)"><STRONG><IMG src="images/help.jpg" border="0"></STRONG></A><BR>
									<BR>
									<EM>(Optional)<BR>
									</EM>
									<BR>
								</FONT>
								<asp:textbox id="Comments" runat="server" maxlength="400" columns="72" width="580px" rows="5"
							...
							<P>
								<asp:label id="ZipLabel" runat="server" font-italic="True">Note: It is not necessary to provide a zip file for your materials.&nbsp;&nbsp;One will be<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;generated automatically.&nbsp;&nbsp;Also, uploaded files must be 60 MB or smaller.</asp:label></P>
							<P>
							...
							<P>
								<asp:textbox id="CheckInTxt" runat="server" maxlength="400" columns="74" width="580px" rows="5"
									textmode="MultiLine"></asp:textbox>
								<asp:customvalidator id="CheckInValidator" runat="server" errormessage="Check In Comments">*Required Field</asp:customvalidator></P>
						</asp:panel>
						<p><asp:button id="BackBtn" runat="server" text="&larr; Back" cssclass="navButton" causesvalidation="False"
								commandname="Back" /><asp:button id="NextBtn" runat="server" text="Next &rarr;" cssclass="navButton" causesvalidation="False"
								commandname="Next" /><asp:button id="SaveBtn" runat="server" text="Save for Later" cssclass="navButton" causesvalidation="False" />
							<asp:button id="SubmitBtn" onclick="SubmitBtn_Click" runat="server" text="Submit" cssclass="navButton" />
							<asp:Button ID="CancelBtn" OnClick="CancelBtn_Click" Runat="server" Text="Cancel Revision" CssClass="navButton" /></p>
					</td>
				</tr>
			</table>
		</form>
